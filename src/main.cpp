...
const string strMessageMagic = "CoreCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
   int64_t nSubsidy = 0 * COIN;
		...
		else if(pindexBest->nHeight == 3)
    {
		...
		else if(pindexBest->nHeight == 4)
    {
		nSubsidy = 10000 * COIN;
	}
		else if(pindexBest->nHeight < 220)
    {
		nSubsidy = 10 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CoreCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CoreCoin PoW PoS";
        CTransaction txNew;
        txNew.nTime = 1404289800;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe3b7af84c3fbb7173fbc11efcde82dd76b3d5ed4ad0b65fda9c17bd660e22a88"));
        block.print();
